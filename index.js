...
client.on('message', msg => {
    ...
    switch (msg.content.toLowerCase()) {
        ...
        case '!version':
            ...
            break;
        default:
            if (msg.content.startsWith('!roll ')) { // && !isNaN(msg.content.substr(msg.content.indexOf(' ') + 1))) {
...
function getHelpMessage() {
    return new MessageEmbed()
        ...
        .addField(`!cal *eventIndex*`, `Show event *eventIndex* where *eventIndex* is a number from 0 to ${vCalendarData.events.length}.`)
        ...
        .addField('!roll *min* *max*', `Roll a random number between *min* and *max*. (Ex. !roll 10 20.)`)
